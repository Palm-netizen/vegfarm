...
1. **Dashboard** — ภาพรวม รอบปลูกปัจจุบัน, อัตรารอด, แปลงมีปัญหา, งานวันนี้, **แจ้งเตือนแปลงใกล้เก็บเกี่ยว (ภายใน 7 วัน/เลยกำหนด)**, ปัญหาล่าสุด, กราฟเปรียบเทียบ, **สำรอง/กู้คืนข้อมูล (Export/Import JSON)**
2. **บันทึกรอบเพาะเมล็ด** — เลือกชนิดผักหลายชนิด, คำนวณอัตรารอด/กิโล/วันเก็บอัตโนมัติ, ตารางแก้ไข/ลบ
3. **รอบปลูกลงแปลง** — 15 แปลง (T1-T15), QR Code ต่อแปลง, ประวัติแต่ละรอบ, เริ่มรอบใหม่, **ย้ายกล้าจากรอบเพาะ → แปลง (เชื่อม seed_batch_id อัตโนมัติ)**, แถบสรุปสถานะแปลง
4. **บันทึกปัญหา** — เลือกแปลง, ประเภทปัญหา, ความรุนแรง, ถ่ายรูป, **ฐานข้อมูลค้นหา + กรอง (ประเภท/ความรุนแรง/สถานะ)**
5. **ปฏิทินภาพรวม** — แสดงกิจกรรมทุกประเภทแยกสี
6. **To-do รายวัน** — สูงสุด 5 งาน/วัน
7. **การเงิน** — รายรับ/รายจ่าย (ระบุแปลง+ชนิดผักได้), hero กำไรสุทธิเดือนนี้, KPI, รายจ่ายแยกหมวด, **รายงานรายได้+ผลผลิตรายแปลง/รายชนิดผัก**, กราฟ 6 เดือน, Export CSV
8. **ลูกค้า** — รายชื่อลูกค้า/ฟาร์ม, ยอดสั่งต่อสัปดาห์, แท็กประเภท
