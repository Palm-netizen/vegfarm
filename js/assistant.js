...
async function assistSeasonCare() {
  ...
  const tips = {
    rainy: '🌧️ หน้าฝน (ฝนสลับแดด) · อัตรารอด 70%\n' +
      '⚠️ ระวัง: รากเน่า · เชื้อรา · ใบอิ่มน้ำ · ค่า pH ดินต่ำ (เป็นกรดจากน้ำฝน)\n' +
      '✅ ควรทำ:\n' +
      '• ยกแปลง/ทำร่องระบายน้ำ อย่าให้แฉะ · ลดรดน้ำช่วงฝนชุก\n' +
      '• อย่าเพิ่งใส่ปุ๋ย ช่วงฟ้าปิด/รากยังอ่อนแอ — รอแดดกลับมาก่อน\n' +
      '• เช็ก/ปรับค่า pH ดิน อย่าให้ต่ำเกินไป (โรยปูนขาว/โดโลไมท์ช่วยได้)\n' +
      '☀️ ช่วงฟ้าปิดหลายวันแล้วแดดออกแรง: กางสแลง/ตาข่ายพรางแสง อย่าให้แดดจัดโดนผักตรงๆ — ผักไม่โดนแดด 3-4 วันจะตั้งตัวไม่ทัน เดี๋ยวเหี่ยว/ใบไหม้',
